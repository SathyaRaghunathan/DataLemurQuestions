...
234	100.00
Explanation
Let\'s consider an example of App 123. This app has a click-through rate (CTR) of 50.00% because out of the 2 impressions it 
received, it got 1 click.
...
FROM events WHERE timestamp >= '2022-01-01' AND timestamp <= '2022-12-31'
GROUP BY 1
